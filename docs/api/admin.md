...
| `tunnelLocalHost` / `tunnelLocalPort` | `string` / `number` | Local Arsenale gateway runtime listener the agent should proxy (`4822` for GUACD, `2222` for SSH, `5432` for DB proxy) |
