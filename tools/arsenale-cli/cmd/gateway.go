...
func init() {
	...
	gwTunnelTokenCreateCmd.Flags().BoolVar(&gwTunnelTokenEnv, "env", false, "Print compose .env-ready tunnel variables")
	gwTunnelTokenCreateCmd.Flags().StringVar(&gwTunnelBundleDir, "bundle-dir", "", "Write tunnel client cert/key files and tunnel.env into this directory")
}
