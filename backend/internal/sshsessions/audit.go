...
func (s Service) insertAuditLog(ctx context.Context, userID, action, targetType, targetID, ipAddress string, details map[string]any) error {
	if s.DB == nil {
		return nil
	}
