...
export const ACTION_LABELS: Record<AuditAction, string> = {
  ...
  SFTP_UPLOAD: 'SFTP Upload (Legacy)',
  SFTP_DOWNLOAD: 'SFTP Download (Legacy)',
  SFTP_DELETE: 'SFTP Delete (Legacy)',
  SFTP_MKDIR: 'SFTP Create Directory (Legacy)',
  SFTP_RENAME: 'SFTP Rename (Legacy)',
  SFTP_LIST: 'SFTP List (Legacy)',
...
export function getActionColor(action: AuditAction): 'default' | 'primary' | 'secondary' | 'error' | 'warning' | 'success' | 'info' {
  ...
  if (['CREATE_CONNECTION', 'CREATE_FOLDER', 'VAULT_SETUP', 'SECRET_CREATE', 'TENANT_VAULT_INIT', 'TENANT_CREATE', 'TEAM_CREATE', 'GATEWAY_CREATE', 'SSH_KEY_GENERATE', 'GATEWAY_TEMPLATE_CREATE', 'FILE_MKDIR', 'SFTP_MKDIR', 'CONNECTION_FAVORITE', 'DB_FIREWALL_RULE_CREATE', 'DB_MASKING_POLICY_CREATE', 'RECORDING_START'].includes(action)) return 'info';
  return 'primary';
}
