...
export function getActionColor(action: AuditAction): 'default' | 'primary' | 'secondary' | 'error' | 'warning' | 'success' | 'info' {
  ...
  if (['CREATE_CONNECTION', 'CREATE_FOLDER', 'VAULT_SETUP', 'SECRET_CREATE', 'TENANT_VAULT_INIT', 'TENANT_CREATE', 'TEAM_CREATE', 'GATEWAY_CREATE', 'SSH_KEY_GENERATE', 'GATEWAY_TEMPLATE_CREATE', 'SFTP_MKDIR', 'CONNECTION_FAVORITE', 'DB_FIREWALL_RULE_CREATE', 'DB_MASKING_POLICY_CREATE'].includes(action)) return 'info';
  return 'primary';
}
...
export const TARGET_TYPES = [
  ...
  'DbFirewallRule', 'DbMaskingPolicy',
];
