...
export const config = {
  ...
  oauth: {
    google: {
      ...
      callbackUrl: process.env.GOOGLE_CALLBACK_URL || 'https://localhost:3000/api/auth/oauth/google/callback',
    ...
    microsoft: {
      ...
      callbackUrl: process.env.MICROSOFT_CALLBACK_URL || 'https://localhost:3000/api/auth/oauth/microsoft/callback',
    ...
    github: {
      ...
      callbackUrl: process.env.GITHUB_CALLBACK_URL || 'https://localhost:3000/api/auth/oauth/github/callback',
    },
    oidc: {
      ...
      callbackUrl: process.env.OIDC_CALLBACK_URL || 'https://localhost:3000/api/auth/oauth/oidc/callback',
    ...
    saml: {
      ...
      callbackUrl: process.env.SAML_CALLBACK_URL || 'https://localhost:3000/api/auth/saml/callback',
