...
export const SETTINGS_REGISTRY: SettingDef[] = [
  ...
  { key: 'GOOGLE_CALLBACK_URL', envVar: 'GOOGLE_CALLBACK_URL', configPath: 'oauth.google.callbackUrl', type: 'string', default: 'https://localhost:3000/api/auth/oauth/google/callback', group: 'oauth-google', label: 'Callback URL', description: 'OAuth redirect URI (must match Google Console).', minEditRole: 'OWNER' },
  ...
  { key: 'MICROSOFT_CALLBACK_URL', envVar: 'MICROSOFT_CALLBACK_URL', configPath: 'oauth.microsoft.callbackUrl', type: 'string', default: 'https://localhost:3000/api/auth/oauth/microsoft/callback', group: 'oauth-microsoft', label: 'Callback URL', description: 'OAuth redirect URI (must match Azure AD app registration).', minEditRole: 'OWNER' },
  ...
  { key: 'GITHUB_CALLBACK_URL', envVar: 'GITHUB_CALLBACK_URL', configPath: 'oauth.github.callbackUrl', type: 'string', default: 'https://localhost:3000/api/auth/oauth/github/callback', group: 'oauth-github', label: 'Callback URL', description: 'OAuth redirect URI (must match GitHub app settings).', minEditRole: 'OWNER' },
  ...
  { key: 'OIDC_CALLBACK_URL', envVar: 'OIDC_CALLBACK_URL', configPath: 'oauth.oidc.callbackUrl', type: 'string', default: 'https://localhost:3000/api/auth/oauth/oidc/callback', group: 'oauth-oidc', label: 'Callback URL', description: 'OIDC redirect URI (must match IdP client configuration).', minEditRole: 'OWNER' },
  ...
  { key: 'SAML_CALLBACK_URL', envVar: 'SAML_CALLBACK_URL', configPath: 'oauth.saml.callbackUrl', type: 'string', default: 'https://localhost:3000/api/auth/saml/callback', group: 'oauth-saml', label: 'Callback URL (ACS)', description: 'Assertion Consumer Service URL (must match IdP config).', minEditRole: 'OWNER' },
