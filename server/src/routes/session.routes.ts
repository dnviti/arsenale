...
router.get('/active', requireTenant, requireTenantRole('ADMIN'), asyncHandler(sessionController.listActiveSessions));
router.get('/count', requireTenant, requireTenantRole('ADMIN'), asyncHandler(sessionController.getSessionCount));
router.get('/count/gateway', requireTenant, requireTenantRole('ADMIN'), asyncHandler(sessionController.getSessionCountByGateway));
